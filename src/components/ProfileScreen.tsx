            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <Input
                  ...
                  className={`pr-9 ${cpfInvalid ? 'border-destructive focus-visible:ring-destructive' : cpfValid ? 'border-green-500 focus-visible:ring-green-500' : ''}`}
                />
                {cpfValid && <CheckCircle className="absolute right-3 top-1/2 -translate-y-1/2 w-4 h-4 text-green-500" />}
